...
## 前提条件<a name="section62921748113314"></a>
...
[①获取文件](#section97292033920)  →  [②配置Weblogic](#section0621183144418)  →  [③效果验证](#section10711447172315)

## 步骤一：获取文件<a name="section97292033920"></a>
...
5.  修改HTTPS端口。
    ...
    **图 4**  端口<a name="fig16458357145714"></a>  
    ![](figures/端口.png "端口")

6.  配置认证方式和密钥。
    1.  在服务器的配置页面，选择“Keystores“页签，配置认证方式。

        **图 5**  认证方式<a name="fig12273281606"></a>  
    ...
    3.  在单向认证中，需要配置JRE默认信任库文件cacerts。
        ...
        **图 7**  信任库文件<a name="fig129941296171"></a>  
...
7.  配置服务器证书私钥别名。
    ...
    **图 8**  私钥<a name="fig93121941132219"></a>  
    ![](figures/私钥.png "私钥")
...
8.  设置完成后，单击“Active Changes“，保存所有修改。
    ...
    **图 9**  保存配置<a name="fig11766113665315"></a>  
    ![](figures/保存配置.png "保存配置")

9.  （可选）如果系统提示需要重启Weblogic，则需要重启后才能使配置生效。如[图10](#fig68541521201719)所示，则无需重启。

    **图 10**  提示信息<a name="fig68541521201719"></a>  
