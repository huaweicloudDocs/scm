...
6.  在“用户组权限“页签中，基于需要授权的区域，单击“设置策略“。

    SCM为全局级服务，只需在全局项目中配置策略。

    **图 6**  策略设置<a name="fig19931209183313"></a>  
    ![](figures/策略设置.png "策略设置")

7.  在弹出的“设置策略“对话框中搜索“SCM“，勾选“SCM Viewer“策略。

    **图 7**  选择策略<a name="fig21621215113813"></a>  
