# 申请证书<a name="ZH-CN_TOPIC_0182547694"></a>
...
-   参数说明
    ...
    <th class="cellrowborder" valign="top" width="20%" id="mcps1.1.5.1.2"><p id="p52341125183817"><a name="p52341125183817"></a><a name="p52341125183817"></a>是否必选</p>
    </th>
    <th class="cellrowborder" valign="top" width="20%" id="mcps1.1.5.1.3"><p id="p649411204388"><a name="p649411204388"></a><a name="p649411204388"></a>参数类型</p>
    </th>
    ...
    <td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.5.1.2 "><p id="p923511252386"><a name="p923511252386"></a><a name="p923511252386"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.5.1.3 "><p id="p24951420123819"><a name="p24951420123819"></a><a name="p24951420123819"></a>String</p>
    </td>
    ...
    <tr id="row124156613477"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.5.1.1 "><p id="p11415461478"><a name="p11415461478"></a><a name="p11415461478"></a>cert_id</p>
    </td>
    <td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.5.1.2 "><p id="p1123572520387"><a name="p1123572520387"></a><a name="p1123572520387"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.5.1.3 "><p id="p164951920123811"><a name="p164951920123811"></a><a name="p164951920123811"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p1141556124717"><a name="p1141556124717"></a><a name="p1141556124717"></a>证书ID</p>
    </td>
    </tr>
    </tbody>
    </table>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p13484173764911"><a name="p13484173764911"></a><a name="p13484173764911"></a>该证书绑定的域名。</p>
<a name="ul9500185641211"></a><a name="ul9500185641211"></a><ul id="ul9500185641211"><li>当购买的证书为<span class="parmvalue" id="parmvalue13897163719185"><a name="parmvalue13897163719185"></a><a name="parmvalue13897163719185"></a>“单域名”</span>或<span class="parmvalue" id="parmvalue15823164518183"><a name="parmvalue15823164518183"></a><a name="parmvalue15823164518183"></a>“泛域名”</span>类型的证书时，请直接填写单域名或泛域名即可。</li><li>当购买的证书为<span class="parmvalue" id="parmvalue2886741101811"><a name="parmvalue2886741101811"></a><a name="parmvalue2886741101811"></a>“多域名”</span>类型的证书时，需要选择1个域名作为主域名。</li></ul>
<p id="p216512338104"><a name="p216512338104"></a><a name="p216512338104"></a>示例：www<span>.</span>example.com</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p7141533181418"><a name="p7141533181418"></a><a name="p7141533181418"></a>绑定多域名类型证书的附加域名。</p>
<p id="p12575039171515"><a name="p12575039171515"></a><a name="p12575039171515"></a>当购买的证书为<span class="parmvalue" id="parmvalue4199350191819"><a name="parmvalue4199350191819"></a><a name="parmvalue4199350191819"></a>“多域名”</span>类型的证书，且有可增加附加域名的额度时，才需要设置该值。</p>
<p id="p1848411373498"><a name="p1848411373498"></a><a name="p1848411373498"></a>多个域名需要以<span class="parmvalue" id="parmvalue176529284119"><a name="parmvalue176529284119"></a><a name="parmvalue176529284119"></a>“;”</span>隔开。</p>
<p id="p104209349113"><a name="p104209349113"></a><a name="p104209349113"></a>示例：www<span>.</span>example.com；www<span>.</span>example1.com；www<span>.</span>example2.com</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p15485337134913"><a name="p15485337134913"></a><a name="p15485337134913"></a>公司名称，OV和EV型证书必填。</p>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p174851237154920"><a name="p174851237154920"></a><a name="p174851237154920"></a>部门名称，OV和EV型证书非必填。</p>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p15978333122119"><a name="p15978333122119"></a><a name="p15978333122119"></a>公司所在省份，OV和EV型证书必填。</p>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p19370539182115"><a name="p19370539182115"></a><a name="p19370539182115"></a>公司所在市区，OV和EV型证书必填。</p>
...
<a name="ul11351649135316"></a><a name="ul11351649135316"></a><ul id="ul11351649135316"><li>CN：中国</li><li>HK：中国香港</li><li>US：美国</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p74851379492"><a name="p74851379492"></a><a name="p74851379492"></a>申请人的姓名。</p>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p1848553734913"><a name="p1848553734913"></a><a name="p1848553734913"></a>申请人的电话号码。</p>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p15485153713499"><a name="p15485153713499"></a><a name="p15485153713499"></a>申请人的邮箱。</p>
<p id="p1055524013379"><a name="p1055524013379"></a><a name="p1055524013379"></a>示例：example.huawei.com</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p1848593734919"><a name="p1848593734919"></a><a name="p1848593734919"></a>技术联系人的姓名。</p>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p84851337124911"><a name="p84851337124911"></a><a name="p84851337124911"></a>技术联系人的电话号码。</p>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p24851737104911"><a name="p24851737104911"></a><a name="p24851737104911"></a>技术联系人的邮箱。</p>
<p id="p12690164019263"><a name="p12690164019263"></a><a name="p12690164019263"></a>示例：example.huawei.com</p>
</td>
</tr>
<tr id="row12641102914812"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.5.1.1 "><p id="p9978845184819"><a name="p9978845184819"></a><a name="p9978845184819"></a>auto_dns_auth</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.5.1.2 "><p id="p25237232499"><a name="p25237232499"></a><a name="p25237232499"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.5.1.3 "><p id="p7410149204913"><a name="p7410149204913"></a><a name="p7410149204913"></a>Boolean</p>
</td>
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.1.5.1.4 "><p id="p1048583710496"><a name="p1048583710496"></a><a name="p1048583710496"></a>是否将DNS验证信息推送到华为云解析服务。</p>
<a name="ul71651626122013"></a><a name="ul71651626122013"></a><ul id="ul71651626122013"><li>true：推送。</li><li>false：不推送。</li></ul>
</td>
</tr>
...
<a name="ul3475174315190"></a><a name="ul3475174315190"></a><ul id="ul3475174315190"><li>true：同意隐私协议。</li><li>false：不同意隐私协议。</li></ul>
<p id="p14141047205"><a name="p14141047205"></a><a name="p14141047205"></a>此处仅能设置为true才能成功申请证书。</p>
</td>
</tr>
</tbody>
</table>
...
<th class="cellrowborder" valign="top" width="20%" id="mcps1.1.5.1.3"><p id="p191635818393"><a name="p191635818393"></a><a name="p191635818393"></a>参数类型</p>
</th>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.5.1.3 "><p id="p1716318813391"><a name="p1716318813391"></a><a name="p1716318813391"></a>String</p>
</td>
