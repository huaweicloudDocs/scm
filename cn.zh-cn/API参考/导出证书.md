# 导出证书<a name="ExportCertificate"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=SCM&api=ExportCertificate)中调试该接口。

## URI

POST /v3/scm/certificates/\{certificate\_id\}/export
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>certificate</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>String</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>证书内容。</p>
<p>最小长度：1</p>
<p>最大长度：4096</p>
</td>
</tr>
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>certificate_chain</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>String</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>证书链。</p>
<p>最小长度：1</p>
<p>最大长度：8192</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>证书私钥。</p>
<p>最小长度：1</p>
<p>最大长度：4096</p>
</td>
</tr>
