# 构造请求<a name="ZH-CN_TOPIC_0182547661"></a>
...
## 请求URI<a name="zh-cn_topic_0171850909_zh-cn_topic_0091607286_section1849899574"></a>
...
**图 1**  URI示意图<a name="zh-cn_topic_0171850909_zh-cn_topic_0091607286_fig949762553218"></a>  
...
## 请求方法<a name="zh-cn_topic_0171850909_zh-cn_topic_0091607286_section580035055419"></a>
...
## 请求消息头<a name="zh-cn_topic_0171850909_zh-cn_topic_0091607286_section1454211155819"></a>
...
-   **X-Auth-Token**：用户Token，可选，当使用Token方式认证时，必须填充该字段。用户Token也就是调用[获取用户Token](https://support.huaweicloud.com/api-iam/iam_30_0001.html)接口的响应值，该接口是唯一不需要认证的接口。
    ...
    >AK/SK认证的详细说明请参见[AK/SK认证](认证鉴权.md#zh-cn_topic_0207581476_zh-cn_topic_0091607401_section5887143815518)。
...
## 请求消息体<a name="zh-cn_topic_0171850909_zh-cn_topic_0091607286_section14612192315587"></a>
